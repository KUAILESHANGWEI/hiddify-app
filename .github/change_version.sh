...
CORE_RELEASE_URL="https://github.com/KUAILESHANGWEI/hiddify-app/releases/download/core-v${CORE_RELEASE_VERSION}/hiddify-core-linux-amd64.tar.gz"
if [ "$(curl -o /dev/null -I -s -w "%{http_code}" "${CORE_RELEASE_URL}")" = "404" ]; then
